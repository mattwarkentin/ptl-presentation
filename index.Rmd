...
- Accelerators
    + CPU, GPU, HPU, IPU, TPU...
    + GPU-acceleration for Macs
        + <https://github.com/PyTorchLightning/pytorch-lightning/issues/13102>
        
- Plugins for mixed precision

- Strategies

- LightningCLI for command-line use

- Environments with support for SLURM
