xaringanthemer::style_xaringan(
  ...
  # Text Font
  text_font_google = xaringanthemer::google_font("Open Sans", "400"),
  text_font_family_fallback = "Avenir",
  text_font_url = xaringanthemer::google_font("Inconsolata", "400"),
  extra_fonts = xaringanthemer::google_font("Yanone Kaffeesatz", "400"),

  # Code Font
  code_font_google = xaringanthemer::google_font("Fira Code", "400"),
